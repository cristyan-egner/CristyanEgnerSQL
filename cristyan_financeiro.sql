...
--
-- Banco de dados: `cristyan_financeiro`
--
DROP DATABASE IF EXISTS `cristyan_financeiro`;
CREATE DATABASE IF NOT EXISTS `cristyan_financeiro` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `cristyan_financeiro`;
...
ELSE
SELECT 'O identificador do rgistro não foi informado!' 
AS Msg;
END IF;
END$$
...
(1, 'Cristyan Egner', '023.456.789-10'),
